...
import { isEmptyString, removeTilde, replaceSpecialChars } from '../src/string-utilities';
...
describe('StringFnUtilities', () => {
  ...
  it('testing no es un string vacío', () => {
    ...
    const allEmpty = stringNull && numberEmpty && stringUndefined && stringArray && stringNoEmpty;
